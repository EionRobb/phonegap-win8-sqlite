...
namespace SQLite3
{
  ...
  {
  public:
	  static property Platform::String^ String { Platform::String^ get() { 
		  static wchar_t buffer[ 21 ];
		  ::MultiByteToWideChar(CP_UTF8, MB_ERR_INVALID_CHARS, SQLITE_VERSION, strlen(SQLITE_VERSION), buffer, 20);
		  return ref new Platform::String(buffer); 
	  } }
	  static property int Integer { int get() { return SQLITE_VERSION_NUMBER; } }
  };
